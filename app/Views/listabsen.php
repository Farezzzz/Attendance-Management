...
<html lang="en">
  <head>
    ...
    <!-- Title -->
    <title>List Absen - SMKN 2 Cimahi Management</title>
    <!-- Fonts -->
  ...
  <body>
    ...
    $absen = $db->query("SELECT * FROM users u LEFT JOIN absensi a ON a.user_id=u.user_id AND a.tanggal='".$tgl."' WHERE $skema $tipe user_status=1 AND user_skema!=1")->getResultArray();
    ?>
    <!-- Preloader -->
    <div id="preloader">
    ...
    <div class="page-content-wrapper" style="margin-top:70px">
            <div class="container">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select" id="skema" name="skema">
                      ...
                      <option value="2,3">Super Team</option>
            ...
            <center><h6>List Absen <?=date('d M Y', strtotime($tgl))?></h6>
            <?php
        ...
        foreach($absen as $d){
        ?>
        <div class="container"><h6 class="mb-1 fz-14"><?=$d['user_name']?>
        <?php
        if($d['tipe']==1){
        ...
        <div class="team-member-wrapper direction-rtl">
            ...
            <div class="row g-3">                       
                ...
                <div class="card team-member-card">
                    ...
                    <!-- Member Image-->
                    <?php if(isset($d['foto'])){ ?>
                    <div class="team-member-img shadow-sm"><img src="img/clockin/<?=$d['foto']?>" alt="" style="object-fit:cover;width:128px;height:128px;"></div>
                    <?php } else { ?>
      ...
      <div class="container px-0">
        ...
        <div class="footer-nav position-relative">
          <ul class="h-100 d-flex align-items-center justify-content-between ps-0">
            ...
            <li class="active"><a href="<?=base_url('listabsen')?>">
                <svg class="bi bi-collection" width="20" height="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M14.5 13.5h-13A.5.5 0 0 1 1 13V6a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5zm-13 1A1.5 1.5 0 0 1 0 13V6a1.5 1.5 0 0 1 1.5-1.5h13A1.5 1.5 0 0 1 16 6v7a1.5 1.5 0 0 1-1.5 1.5h-13zM2 3a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11A.5.5 0 0 0 2 3zm2-2a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 0-1h-7A.5.5 0 0 0 4 1z"></path>
                </svg><span>List Absen</span></a></li>
            <li><a href="<?=base_url('rekapabsen')?>">
