    ...
    <div class="page-content-wrapper py-3">
      ...
      <div class="container">
        ...
        <div class="card user-data-card">
          <div class="card-body">
            <form action="<?=base_url('siswa/clockin/save')?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group mb-3">
                <label class="form-label" for="tipe">Tipe Absen</label>
                <select class="form-select" id="tipe" name="tipe">
                  <option value="1">Masuk Sekolah</option>
              ...
              <button class="btn btn-success w-100" type="submit">Clock In</button>
            </form>
          </div>
        </div>
      </div>
