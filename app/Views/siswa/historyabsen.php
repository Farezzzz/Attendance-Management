...
<body>
  ...
  $user_id = (isset($_GET['user']) && $_GET['user'] != "") ? $_GET['user'] : $session->get('user_id');

  $where = array('tanggal >=' => $tgl, 'tanggal <=' => $tglA, 'user_id' => $user_id);
    ...
    <div class="offcanvas-body p-0">
      ...
      <div class="sidenav-wrapper">
        ...
        <div class="sidenav-profile bg-gradient">
          ...
          $foto = "img/tim/{$user_nik}.jpg"; // path gambar
          ?>
          <div class="user-profile"><img src="<?= base_url($foto) ?>" alt=""></div>
          <!-- User Info -->
          <div class="user-info">
        ...
        <div class="copyright-info">
          <p>2023 &copy; Made by<a href="https://smkn2cmi.sch.id">RPL SMKN 2 Cimahi</a></p>
        </div>
      </div>
    </div>
  </div>
  <div class="page-content-wrapper" style="margin-top:70px">
    <div class="container">
      ...
      <div class="element-heading">
        <center>
          <h6>History Absen <?= date('d M Y', strtotime($tgl)) ?> - <?= date('d M Y', strtotime($tglA)) ?></h6>
          <?php
    ...
    ?>
      <div class="container">
        <h6 class="mb-1 fz-14"><?= $user['user_name'] ?> (<?= date('d M Y', strtotime($d['tanggal'])) ?>)
          <?php
          if ($d['tipe'] == 1) {
    ...
    <div class="container px-0">
      ...
      <div class="footer-nav position-relative">
        <ul class="h-100 d-flex align-items-center justify-content-between ps-0">
          ...
          <li class="active"><a href="<?= base_url('siswa/historyabsen') ?>">
